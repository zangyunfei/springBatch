package cn.zyf.study.springbatch.demo;
...
public class JobCompletionNotificationListener extends
    ...
    public void afterJob(JobExecution jobExecution) {
        if (jobExecution.getStatus() == BatchStatus.COMPLETED) {
            JobCompletionNotificationListener.log
                .info("!!! JOB FINISHED! Time to verify the results");
            ...
            for (Person person : results) {
                JobCompletionNotificationListener.log.info("Found <" + person
                    + "> in the database.");
            }
